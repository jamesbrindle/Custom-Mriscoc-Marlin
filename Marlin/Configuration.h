 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 1000 }  // Ender Configs
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -7, -2.13 }  // MRiscoC BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)  // Manual mesh use the nozzle as probe
...
#define XY_PROBE_FEEDRATE (160*60)  // MRiscoC increase travel speed between probes
...
#define PREHEAT_BEFORE_LEVELING  // MRiscoC Heatting to compensate thermal expansions
  ...
  #define LEVELING_NOZZLE_TEMP 0   // (°C) Only applies to E0 at this time  // Preheat nozzle without oozing
...
#define HOMING_FEEDRATE_MM_M { (60*60), (60*60), (15*60) }  // MRiscoC Homing speed-up
...
#define NOZZLE_PARK_FEATURE  // MRiscoC Enabled
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MIN_POS + 22), 10 }
