 ...
 */
#define FAN_MIN_PWM 178  // Ender Configs
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  31.36          // (Hz) The default dominant resonant frequency on the X axis.
 ...
 */
#define DEFAULT_STEPPER_TIMEOUT_SEC 345600
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.44 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.44        // (mm) Compression length applying to all extruders
  #endif
...
#define ADVANCED_PAUSE_FEATURE  // MRiscoC Enabled
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     80  // (mm/s) Unload filament feedrate. This can be pretty fast.  // MRiscoC Increased filament unload speed
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  40  // (mm/s) Load filament feedrate. This can be pretty fast.  // MRiscoC Increased filament load speed
